...
class _InfoUserScreenState extends State<InfoUserScreen> {
  ...
  Future<void> updateData() async {
    ...
    user.phoneNumber = PhoneNumberCumbia(
        dialingCode: "+57", basePhoneNumber: phoneController.text.trim());
  ...
  Future<void> _uploadUserAvatar() async {
    if (auxImage != null) {
      ...
      Reference storageRef =
          _fstorage.ref().child('thumbnails/${random.nextInt(1000000000)}');
      UploadTask uploadTask = storageRef.putFile(auxImage);
