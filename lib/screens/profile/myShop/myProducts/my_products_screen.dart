  ...
  void list() {
    ...
    productsData.forEach((element) => {
          productsBackup.add(RegisteredProductItem(
            ...
            description: element.color == null &&
                    element.dimension == null &&
                    element.size == null
                ? "No especifica"
                : element.color == "No especifica" &&
                        element.dimension == "No especifica" &&
                        element.size == "No especifica"
                    ? "No especifica"
                    : element.color == "" &&
                            element.dimension == "" &&
                            element.size == ""
                        ...
                        : element.color == "No especifica" ||
                                element.color == ""
                            ? "${element.dimension}/${element.size}"
                            : element.dimension == "No especifica" ||
                                    element.dimension == ""
                                ? "${element.color}/${element.size}"
                                : element.size == "No especifica" ||
                                        element.size == ""
                                    ? "${element.color}/${element.dimension}"
                                    : "${element.color}/${element.dimension}/${element.size}",
