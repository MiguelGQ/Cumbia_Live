              ...
              onTap: () async {
                ...
                await References.products
                  ...
                  for (var i = 0; i < value.docs.length; i++) {
                    p.add(new Product(
                      imageUrl: value.docs.elementAt(i).data()['productInfo']
                          ['imageUrl'],
                      productName: value.docs.elementAt(i).data()['productInfo']
                          ['productName'],
                      description: value.docs.elementAt(i).data()['productInfo']
                          ['description'],
                      avaliableUnits:
                          value.docs.elementAt(i).data()['avaliableUnits'],
                      id: value.docs.elementAt(i).id,
                      color: value.docs.elementAt(i).data()['variantInfo']
                          ['color'],
                      size: value.docs.elementAt(i).data()['variantInfo']
                          ['size'],
                      dimension: value.docs.elementAt(i).data()['variantInfo']
                          ['dimension'],
                    ));
                  }
                }).then((value) async {
                      ...
                      await References.purchases
                        ...
                        value.docs.forEach((pur) {
                          ventas[i].products.add(Product(
                                ...
                                rated: pur.data()['rated'],
                                isFreeShipping:
                                    pur.data()['isFreeShipping'] ?? false,
                                isShipmentRequired:
                                    pur.data()['isShipmentRequired'] ?? true,
                              ));
                        });
                      });
                    }
              ...
              onTap: () async {
                ...
                await References.merchant
                    ...
                    .then((value) => merchant = new Merchant(
                        shopName: value.docs.first.data()['shopName'] ?? '',
                        pickUpPoint:
                            value.docs.first.data()['pickUpPoint'] ?? null,
                        instagram: value.docs.first.data()['instagram'] ?? null,
                        webPage: value.docs.first.data()['webPage'] ?? null,
                        category1:
                        ...
                        storeLocation: Address(
                          address:
                              value.docs.first.data()['storeLocation'] != null
                                  ? value.docs.first.data()['storeLocation']
                                      ['address']
                                  : "",
                          city: value.docs.first.data()['storeLocation'] != null
                              ? value.docs.first.data()['storeLocation']['city']
                              : "",
                          country:
                              value.docs.first.data()['storeLocation'] != null
                                  ? value.docs.first.data()['storeLocation']
...
Future<void> _setIsOpen(isOpen) async {
  ...
  await References.merchant
      ...
      .then((value) => {
            References.merchant.doc(document).update({'isOpen': isOpen})
          });
}
